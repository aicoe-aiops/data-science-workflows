...
image:../assets/images/workflow_diagram.png[Workflow diagram]

Each task stores the rendered notebook as an artifact:

image:../assets/images/workflow_artifacts.png[Artifacts]

And since it's Argo, it can provide a quite detailed insight into the tasks, like a timeline drilldown:

image:../assets/images/workflow_drilldown.png[Timeline]
